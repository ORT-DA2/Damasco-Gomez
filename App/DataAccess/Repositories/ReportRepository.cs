                ...
                .Select(
                    h => new Report(){ 
                        ...
                        .Where(b => 
                            ...
                            ((b.CheckIn <= dateFrom && b.CheckOut>=dateOut)|| (b.CheckIn >dateFrom && b.CheckOut<=dateOut)|| (dateFrom> b.CheckIn && dateOut> b.CheckOut)|| (dateFrom < b.CheckIn && dateOut = b.CheckIn)|| (dateFrom=b.CheckOut && dateOut>=b.CheckOut))
                            .Count()}).ToList();
